...
export default function Swap() {
  ...
  const connection = new Connection(
    'https://mainnet.helius-rpc.com/?api-key=b956a5d5-4c8f-4caa-9956-3c36d31d17bc'
  );
  ...
  async function getQuote(currentAmount: number) {
    ...
    const quote = await (
      await fetch(
        `https://quote-api.jup.ag/v6/quote?inputMint=${fromAsset.mint}&outputMint=${toAsset.mint}&amount=${currentAmount * Math.pow(10, fromAsset.decimals)}&slippage=0.3`
      )
    ).json();
